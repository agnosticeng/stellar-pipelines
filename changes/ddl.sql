            ...
            $JSON$
            {
                ...
                "schema": {
                    ...
                    "fields": [
                        ...
                        {"id": 11   , "name": "source"                                      , "type": "string"      , "required": true},
                        {"id": 12   , "name": "type"                                        , "type": "string"      , "required": true},
                        {"id": 13   , "name": "last_modified_ledger_sequence"               , "type": "long"        , "required": true},
                        {"id": 14   , "name": "ledger_entry_type"                           , "type": "string"      , "required": true},
                        {"id": 15   , "name": "ledger_entry_data"                           , "type": "binary"      , "required": true}
                    ]
                },
